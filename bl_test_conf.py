...
from ophyd.userapi.scan_api import DScan, AScan, Count
...
#clr_trig = EpicsSignal('XF:23ID2-ES{Sclr:1}.CNT', rw=True, name='sclr_trig')
#clr_ch1 = EpicsSignal('XF:23ID2-ES{Sclr:1}.S1', rw=False, name='sclr_ch1')
#ca = EpicsScaler('XF:23ID2-ES{Sclr:1}', name='sca')

ct = Count()
ct.default_detectors = [sensor1]
