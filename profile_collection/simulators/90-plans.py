...
# gave up on adaptive scan; it wasn't working well
...
# Deprecated : Dan's old code
def Ecal_old(detectors, motor, guessed_energy, mode, *,
...
def fit_Ecal_dips_symmetric(xdata, ydata, guessed_sigma=.01, wguess=66., D="Si", theta_offset=-35.26):
    '''
